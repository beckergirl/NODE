...
function deleteProfessional(request, response){  // delete: borrar datos.
    ...
    if(profesionales[posicion] != null){
        ...
        profesionales.splice([posicion],1);/// eliminar El método splice() cambia el contenido de un array eliminando elementos existentes y/o agregando nuevos elementos.
        respuesta = {error: false, codigo: 200,
